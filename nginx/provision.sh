...
yum -y install wget yum-utils pcre-devel lua-devel openssl-devel gd-devel geoip-devel cifs-utils ca-certificates

# NGINX-Plus
mkdir -p /etc/ssl/nginx
cp /vagrant/nginx-repo.key /etc/ssl/nginx/
cp /vagrant/nginx-repo.crt /etc/ssl/nginx/
